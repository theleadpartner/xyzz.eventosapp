...
$eventosapp_branding_ver = is_readable( $eventosapp_branding_file ) ? (string) filemtime( $eventosapp_branding_file ) : '1.5.0-rc.20';
...
<head>
    ...
    <style id="eventosapp-unified-managed-page-layout">
