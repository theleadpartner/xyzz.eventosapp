...
add_action('elementor/widgets/register', function( $widgets_manager ) {
    ...
    if ( ! class_exists('EventosApp_Elementor_Virtual_Landing_Widget') ) {
        class EventosApp_Elementor_Virtual_Landing_Widget extends \Elementor\Widget_Base {
            ...
            public function get_keywords() {
                return ['eventosapp', 'virtual', 'landing', 'evento'];
            }
            ...
            protected function register_controls() {
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'raw'  => 'Coloca este widget en la página base /virtual. La URL /virtual/nombre-del-evento cargará automáticamente la landing configurada en el CPT del evento.',
                    ]
                );
    ...
    $widgets_manager->register( new \EventosApp_Elementor_Virtual_Landing_Widget() );
});
